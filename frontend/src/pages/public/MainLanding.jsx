...
import { 
  ...
  X, Building2, CheckCircle, TrendingUp, Award
} from 'lucide-react';
...
const MainLanding = () => {
  ...
  // Business showcase with 20 real Pexels images (free, no attribution required)
  ...
  const features = [
    {
      ...
      description: 'Real-time order processing and instant notifications',
    ...
    },
    {
      ...
      description: 'Accept orders directly from WhatsApp',
  ...
  ).slice(0, 6); // Show only 6 featured businesses
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${
        ...
        <nav className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            >
              ...
              <div>
                <h1 className={`text-xl font-black tracking-tight ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                  MyPadiBusiness
                </h1>
                <p className={`text-[10px] uppercase tracking-wider ${darkMode ? 'text-gray-500' : 'text-gray-500'}`}>
                  Business Platform
                </p>
              </div>
            </motion.div>
      ...
      {/* Hero Section with Real Images/Videos */}
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        
        {/* Real Business Images Background */}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div 
                ...
                style={{
                  backgroundImage: `url('${businessShowcase[currentVideoIndex].image}')`,
                }}
              />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed text-white/90 drop-shadow-md">
              {t.heroSub}
            </p>
            ...
            {features.map((feature, i) => (
              <motion.div
                ...
                className={`p-8 rounded-2xl transition-all ${
                  darkMode ? 'bg-white/5 border border-white/10 hover:border-white/20' : 'bg-white border border-gray-200 hover:border-gray-300'
                }`}
              >
          ...
          >
            <div className={`relative rounded-2xl shadow-xl ${darkMode ? 'bg-white/5 border border-white/10' : 'bg-white border border-gray-200'}`}>
              ...
              <input
                ...
                className={`w-full pl-14 pr-6 py-4 rounded-2xl text-lg focus:outline-none ${
                  darkMode ? 'bg-transparent text-white placeholder-gray-500' : 'bg-transparent text-gray-900 placeholder-gray-400'
                }`}
              />
            </div>
          </motion.div>
            ...
            <div className="text-center py-20">
              <motion.div
                ...
                className={`w-16 h-16 border-4 rounded-full mx-auto ${
                  darkMode ? 'border-white/10 border-t-orange-500' : 'border-gray-200 border-t-orange-500'
                }`}
              />
            </div>
              ...
              {filteredBusinesses.map((business, i) => (
                <motion.a
                  ...
                  className={`group p-6 rounded-2xl transition-all ${
                    darkMode ? 'bg-white/5 border border-white/10 hover:border-orange-500/50' : 'bg-white border border-gray-200 hover:border-orange-500'
                  }`}
                >
                    ...
                    <div className="flex-1">
                      ...
                      {business.businessType && (
                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${
                          darkMode ? 'bg-white/10 text-gray-300' : 'bg-orange-100 text-orange-700'
                        }`}>
                          {business.businessType}
                        </span>
                      )}
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center text-white">
          ...
          <motion.p
            ...
            className="text-xl lg:text-2xl mb-10 opacity-90"
          >
            {t.ctaSub}
          </motion.p>
          <motion.button
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-xl border-2 focus:outline-none transition-colors ${
                            darkMode ? 'bg-white/5 border-white/10 focus:border-orange-500 text-white' : 'bg-white border-gray-200 focus:border-orange-500'
                          }`}
